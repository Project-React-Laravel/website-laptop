...
import { faGamepad, faGraduationCap, faLaptop, faPenRuler, faUserTie } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className={cx('wrapper')}>
                ...
                <div className={cx('wrapper')}>
                    ...
                    <div className={cx('cate-container')}>
                        <div className={cx('cate-item')}><CateIcon>{faGamepad}</CateIcon><p>Laptop Gaming</p></div>
                        <div className={cx('cate-item')}><CateIcon>{faGraduationCap}</CateIcon><p>Laptop Sinh Viên</p></div>
                        <div className={cx('cate-item')}><CateIcon>{faPenRuler}</CateIcon><p>Laptop Đồ Họa</p></div>
                        <div className={cx('cate-item')}><CateIcon>{faUserTie}</CateIcon><p>Laptop Doanh Nhân</p></div>
                        <div className={cx('cate-item')}><CateIcon>{faLaptop}</CateIcon><p>Laptop Mỏng Nhẹ</p></div>
                    </div>
                </div>
                <div className={cx('wrapper')}>
                    <h1 style={{
