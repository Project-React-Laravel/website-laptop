        ...
        <div className={cx('wrapper')}>
            ...
            <div className={cx('content')}>
                <div className={cx('filter')}>
                    ...
                    <FilterGroup children={'Độ phân giải'} label={["HD", "FullHD","Retina","2K","4K","8K"]} type="Button"></FilterGroup> 
                ...
                <div className={cx('list')}>
                    ...
                    <div className={cx('list-card')}>
                        {products.map( product =>
                            <Card name={product.name}  price={product.price} image={product.image_url}></Card>
                        )} 
                    </div>
                </div>
            </div>
