            ...
            <div className={cx('Header_container_top')}>
                <div className={cx('Header_full')}>
                    ...
                    <div className={cx('Header_full_3')}>
                        ...
                        <div className={cx('Header_full_3_1')}>
                            <Link to="/cart">
                                <FontAwesomeIcon icon={faCartShopping} className={cx('bag')} />
                            </Link>
                            ...
                            <div className={cx('Header_full_3_1_Listcard')}>
                                ...
                                <div className={cx('Header_full_3_1_Listcard_2')}></div>
                        ...
                        <div className={cx('Header_full_3_1')}>
                            {username ? (
                                <div  style={{display:'flex',justifyContent:'space-around',fontSize:'15px',fontWeight:600}}>
                                    <p style={{marginRight:15}}>Chào {username}</p>
                                        ...
                                        <div className={cx('Header_full_bottom_show_shop_main')}>
                                            <div className={cx('Header_full_bottom_show_shop_main_block')}>
                                                ...
                                                <div className={cx('Header_full_bottom_show_shop_1')}>
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <Link to="/shop">Shop Fullwidth</Link>
                                                        </li>
                                                        <li>
                                                            <Link to="/shop">Shop Category Icon</Link>
                                                        </li>
                                                        <li>
                                                            <Link to="/shop">Shop Category Icon</Link>
                                                        </li>
                                                        <li>
                                                            <Link to="/shop">Shop List View</Link>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div className={cx('Header_full_bottom_show_shop_main_block')}>
                                                ...
                                                <div className={cx('Header_full_bottom_show_shop_1')}>
                                                    <ul>
                                                        <li>
                                                            <Link to="/shop">Horizonral Thumbnail</Link>
                                                        </li>
                                                        <li>
                                                            <Link to="/shop">Vertical Thumbnail</Link>
                                                        </li>
                                                        <li>
                                                            <Link to="/shop">Gallery Thumbnail</Link>
                                                        </li>
                                                        <li>
                                                            <Link to="/shop">Sticky Summary</Link>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div className={cx('Header_full_bottom_show_shop_main_block')}>
                                                ...
                                                <div className={cx('Header_full_bottom_show_shop_1')}>
                                                    <ul>
                                                        <li>
                                                            <Link to="/shop">Phone & Tablet</Link>
                                                        </li>
                                                        <li>
                                                            <Link to="/shop">Gaming & Sports</Link>
                                                        </li>
                                                        <li>
                                                            <Link to="/shop">Home Appliance</Link>
                                                        </li>
                                                        <li>
                                                            <Link to="/shop">Fashion Clothes</Link>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
