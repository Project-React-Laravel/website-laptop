            ...
            <div className={cx('Header_container_top')}>
                <div className={cx('Header_full')}>
                    ...
                    <div className={cx('Header_full_2')}>
                        ...
                        <div className={cx('Header_full_2_2')}></div>
                    ...
                    <div className={cx('Header_full_3')}>
                        <div className={cx('Header_full_3_1')}>
                            <a href="/">
                                <span>
                                    <FontAwesomeIcon icon={faArrowRotateBack} className={cx('arrow_rotate')} />
                                </span>
                            </a>
                        </div>
                        <div>
                        ...
                        <div>
                            <a href="/" style={{ textDecoration: 'none' }}>
                                <NavLink to="/cart" style={{ color: '#71716c', textDecoration: 'none' }}>
                        ...
                        <div>
                            <a href="/">
                                <NavLink to="/login" style={{ color: '#000000', textDecoration: 'none' }}>
                                    <span>
                ...
                <div className={cx('Header_full_bottom_1')}>
                        ...
                        <div className={cx('Header_full_bottom_1_2')}>
                            <ul>
                                <li className={cx('Header_show_control1')}>
                                    <span>
                                        <NavLink to="/" style={{ color: '#000000', textDecoration: 'none' }}>
                                            Home
                                        </NavLink>
                                        <span>
                                            {' '}
                                    ...
                                    <div className={cx('Header_full_bottom_show_home')}>
                                        <div>
                                            <ul>
                                                <li>
                                                    <a href="/shop">Home One</a>
                                                </li>
                                                <li>
                                                    <a href="/shop">Home Two</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <li className={cx('Header_show_control3')}>
                                    <span>
                                        <NavLink to="/shop" style={{ color: '#000000', textDecoration: 'none' }}>
                                            Shop
                                        </NavLink>
                                        <span>
                                            {' '}
                                    ...
                                    <div className={cx('Header_full_bottom_show_shop')}>
                                        <div className={cx('Header_full_bottom_show_shop_main')}>
                                            <div className={cx('Header_full_bottom_show_shop_main_block')}>
                                                <div className={cx('Header_full_bottom_show_shop_main_h1')}>
                                                    <h1>Shop LIST</h1>
                                                </div>
                                                <div className={cx('Header_full_bottom_show_shop_1')}>
                                                    <ul>
                                                        <li>
                                                            <a href="/shop">Shop Sidebar</a>
                                                        </li>
                                                        <li>
                                                            <a href="/shop">Shop Fullwidth</a>
                                                        </li>
                                                        <li>
                                                            <a href="/shop">Shop Category Icon</a>
                                                        </li>
                                                        <li>
                                                            <a href="/shop">Shop Category Icon</a>
                                                        </li>
                                                        <li>
                                                            <a href="/shop">Shop List View</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div className={cx('Header_full_bottom_show_shop_main_block')}>
                                                ...
                                                <div className={cx('Header_full_bottom_show_shop_1')}>
                                                    <ul>
                                                        <li>
                                                            <a href="/shop">Horizonral Thumbnail</a>
                                                        </li>
                                                        <li>
                                                            <a href="/shop">Vertical Thumbnail</a>
                                                        </li>
                                                        <li>
                                                            <a href="/shop">Gallery Thumbnail</a>
                                                        </li>
                                                        <li>
                                                            <a href="/shop">Sticky Summary</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div className={cx('Header_full_bottom_show_shop_main_block')}>
                                                <div className={cx('Header_full_bottom_show_shop_main_h1')}>
                                                    <h1>POLULAR CATEGORY</h1>
                                                </div>
                                                <div className={cx('Header_full_bottom_show_shop_1')}>
                                                    <ul>
                                                        <li>
                                                            <a href="/shop">Phone & Tablet</a>
                                                        </li>
                                                        <li>
                                                            <a href="/shop">Gaming & Sports</a>
                                                        </li>
                                                        <li>
                                                            <a href="/shop">Home Appliance</a>
                                                        </li>
                                                        <li>
                                                            <a href="/shop">Fashion Clothes</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                    ...
                    <div className={cx('Header_full_bottom_2')}>
                        <button>
                            ...
                            <span>
                                <FontAwesomeIcon icon={faChevronRight} className={cx('arrow_right')} />
                            </span>
                        </button>
                    </div>
                </div>
